...
namespace CACPP {
	...
	{
		ref struct GenSize {
			int WinH; //øèðèíà è âûñîòà îêíà
			int	WinW;
			int TextH; //øèðèíà è âûñîòà îêíà
			int	TextW;
			int PanelH; //Ðàñïîëîæåíèå ïàíåëè
			int PanelWPoint;
			int PanelListH;
		};
	public:
	...
	private: System::Windows::Forms::ToolStripMenuItem^ belarussianÁåëàðóñê³ToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		/// </summary>
		   void InitializeComponent(void)
		   {
			   ...
			   this->belarussianÁåëàðóñê³ToolStripMenuItem->Click += gcnew System::EventHandler(this, &MainWindow::menuLanguageBe);
			   // 
			   // toolStripSeparator2
			   // 
...
#pragma endregion
	...
	private: bool open() {
		if (this->filecpp->Status) {
			...
			dr = MessageBox::Show("Ñîõðàíèòü ôàéë?", "Ôàéë íå ñîõðàíåí!", MessageBoxButtons::YesNoCancel);
