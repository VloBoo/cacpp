...
#pragma region Windows Form Designer generated code
		...
		/// </summary>
		   void InitializeComponent(void)
		   {
			   ...
			   this->belarussianÁåëàğóñê³ToolStripMenuItem->Click += gcnew System::EventHandler(this, &MainWindow::menuLanguageBe);
			   // 
			   // toolStripSeparator2
			   // 
...
#pragma endregion
	...
	private: bool open() {
		if (this->filecpp->Status) {
			...
			dr = MessageBox::Show("Ñîõğàíèòü ôàéë?", "Ôàéë íå ñîõğàíåí!", MessageBoxButtons::YesNoCancel);
